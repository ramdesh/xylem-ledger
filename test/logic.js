...
const namespace = 'org.rdeshapriya.xylem';
...
describe('#' + namespace, () => {
    ...
    describe('ChangeDeviceToken()', () => {
        it('should change the value property of ' + assetType + ' to newToken', () => {
            const factory = businessNetworkConnection.getBusinessNetwork().getFactory();

            // Create a user participant
            const user = factory.newResource(namespace, 'User', 'Ramindu Deshapriya');
            ...
            const changeDeviceToken = factory.newTransaction(namespace, 'ChangeDeviceToken');
            changeDeviceToken.relatedDevice = factory.newRelationship(namespace, assetType, asset.$identifier);
            changeDeviceToken.newToken = 'new-value';
